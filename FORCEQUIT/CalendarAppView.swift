...
/// Static calendar clue window that can be moved around the desktop.
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                ...
                if viewModel.shouldShowDragHint(for: "calendar") {
                    showDragHint = true
                    viewModel.markDragHintShown(for: "calendar")
                }
            }
