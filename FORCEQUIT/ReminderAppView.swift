...
/// Static reminder clue window that supports dragging and focus changes.
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                ...
                if viewModel.shouldShowDragHint(for: "reminder") {
                    showDragHint = true
                    viewModel.markDragHintShown(for: "reminder")
                }
            }
