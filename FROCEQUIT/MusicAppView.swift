...
/// Static music clue window that behaves like a draggable desktop app.
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                ...
                if viewModel.shouldShowDragHint(for: "music") {
                    showDragHint = true
                    viewModel.markDragHintShown(for: "music")
                }
            }
