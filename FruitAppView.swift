...
/// Static image clue window presented as the desktop photo app.
struct FruitAppView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                ...
                if viewModel.shouldShowDragHint(for: "fruit") {
                    showDragHint = true
                    viewModel.markDragHintShown(for: "fruit")
                }
            }
